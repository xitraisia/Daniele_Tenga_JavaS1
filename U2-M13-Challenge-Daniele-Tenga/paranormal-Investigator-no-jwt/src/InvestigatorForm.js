            ...
            <form onSubmit={handleSubmit}>
                {/* <div className="mb-3">
                    ...
                    <input type="text" id="brief" name="brief"
                        ...
                        value={investigator.brief} onChange={handleChange} />
                </div> */}
                <div className="mb-3">
                    <label htmlFor="firstName">First Name</label>
                    <textarea id="firstName" name="firstName" className="form-control"
                        value={investigator.firstName} onChange={handleChange}></textarea>
                </div>
                <div className="mb-3">
